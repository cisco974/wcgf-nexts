...
-- Insert initial game pages
INSERT INTO game_pages (game_id, page_type_id, content, meta, is_published, created_at, updated_at)
SELECT 
  g.id as game_id,
  pt.id as page_type_id,
  '{"en": {"page_header": {"title": "SUPER TAROT"}, "introduction": {"title": "Welcome to Super Tarot", "text": "Discover the world of Super Tarot from World Card Games Federation, a thrilling card game of strategy and skill."}}}' as content,
  '{"en": {"title": "Super Tarot | WCGF", "description": "Play Super Tarot online - the classic strategy card game", "keywords": "tarot, card game, strategy game", "og_title": "Super Tarot | WCGF", "og_description": "Play Super Tarot online", "og_image": "/img/tarot/tarot-en.webp"}}' as meta,
